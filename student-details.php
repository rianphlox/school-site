<?php
    ...
    require_once '../School/config/DB.php';
    $db = new DB();
    session_start();
    ...
    $sql = "SELECT * FROM student_auth WHERE id = $id";
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="personal-activity">
                                                ...
                                                <div class="views-personal">
                                                    <h4>Email</h4>
                                                    <h5><a href="javascript:void(0)" class="__cf_email__" data-cfemail="3e5a5f574d477e59535f5752105d5153"><?= $email ?></a></h5>
                                                </div>
                                            </div>
                                            <div class="personal-activity">
                                                <div class="personal-icons">
