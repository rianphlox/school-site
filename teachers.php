                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu active">
                            ...
                            <ul>
                                <li><a href="teachers" class="active">Teacher List</a></li>
                                <li><a href="teacher-details">Teacher View</a></li>
                                <li><a href="add-teacher">Teacher Add</a></li>
                                <li><a href="edit-teacher">Edit Teacher Profile</a></li>
                                ...
                                <div class="page-header">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto text-end float-end ms-auto download-grp">
                                            <a href="teachers" class="btn btn-outline-gray me-2 active"><i class="feather-list"></i></a>
                                            <a href="teachers-grid" class="btn btn-outline-gray me-2"><i class="feather-grid"></i></a>
                                            <a href="#" class="btn btn-outline-primary me-2"><i class="fas fa-download"></i> Download</a>
                                            <a href="add-teacher" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="teacher-details" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-02.jpg" alt="User Image"></a>
                                                        <a href="teacher-details">Aaliyah</a>
                                                    </h2>
                                                </td>
                                                <td>10</td>
                                                <td>Female</td>
                                                ...
                                                <td class="text-end">
                                                    <div class="actions">
                                                        ...
                                                        <a href="edit-teacher" class="btn btn-sm bg-danger-light">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="teacher-details" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-03.jpg" alt="User Image"></a>
                                                        <a href="teacher-details">Malynne</a>
                                                    </h2>
                                                </td>
                                                <td>8</td>
                                                <td>Female</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="teacher-details" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-04.jpg" alt="User Image"></a>
                                                        <a href="teacher-details">Levell Scott</a>
                                                    </h2>
                                                </td>
                                                <td>10</td>
                                                <td>Male</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="teacher-details" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-05.jpg" alt="User Image"></a>
                                                        <a href="teacher-details">Minnie</a>
                                                    </h2>
                                                </td>
                                                <td>11</td>
                                                <td>Male</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="teacher-details" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-06.jpg" alt="User Image"></a>
                                                        <a href="teacher-details">Lois A</a>
                                                    </h2>
                                                </td>
                                                <td>10</td>
                                                <td>Female</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="teacher-details" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-07.jpg" alt="User Image"></a>
                                                        <a href="teacher-details">Calvin</a>
                                                    </h2>
                                                </td>
                                                <td>9</td>
                                                <td>Male</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="teacher-details" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-08.jpg" alt="User Image"></a>
                                                        <a href="teacher-details">Vincent</a>
                                                    </h2>
                                                </td>
                                                <td>10</td>
                                                <td>Male</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="teacher-details" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-09.jpg" alt="User Image"></a>
                                                        <a href="teacher-details">Kozma Tatari</a>
                                                    </h2>
                                                </td>
                                                <td>9</td>
                                                <td>Female</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="teacher-details" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-10.jpg" alt="User Image"></a>
                                                        <a href="teacher-details">John Chambers</a>
                                                    </h2>
                                                </td>
                                                <td>11</td>
                                                <td>Male</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="teacher-details" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/img/profiles/avatar-11.jpg" alt="User Image"></a>
                                                        <a href="teacher-details">Nathan Humphries</a>
                                                    </h2>
                                                </td>
                                                <td>10</td>
                                                <td>Male</td>
